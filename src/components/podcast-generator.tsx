...
const togglePlayPause = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-white relative">
      {/* Background SVG */}
        ...
        {step === 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-6">Create your own personalized podcast in just a few steps, powered by Generative AI</p>
              <motion.button
                onClick={handleStartGenerate}
                className="px-8 py-4 text-lg font-semibold bg-zinc-600 hover:bg-zinc-700 text-white rounded-lg shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-opacity-50"
            ...
            <div className="hidden md:block">
              <img src="illustration.png?height=100&width=100" alt="AI Podcast Illustration" className="w-full h-auto" />
            </div>
          </div>
        )}
                  ...
                  <CardContent className="p-6">
                    ...
                    <form onSubmit={handleTopicSubmit} className="space-y-4">
                      <div className="flex items-center">
                        <Input
                          type="text"
                          placeholder="e.g., Climate Change, AI, Indian Economy"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      >
                        <CardContent className="p-4 flex flex-col items-center">
                          <Mic className="h-16 w-16 text-zinc-600 mb-4" />
    ...
    <div className="text-red-500 mt-2">{audioError}</div>
                    ...
                    <div className="flex items-center justify-center space-x-6">
                      <Button 
                        variant="default"
                        size="icon"
                        className="bg-zinc-600 text-white rounded-full hover:bg-zinc-700 h-12 w-12"
                        onClick={togglePlayPause}
                      >
                        {isPlaying ? <Pause className="h-6 w-6" /> : <Play className="h-6 w-6" />}
                      </Button>
                      <div className="relative group">
                        <Button variant="ghost" size="icon" className="hover:text-zinc-600">
